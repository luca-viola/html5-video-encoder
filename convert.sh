...
DURATION=`ffprobe -loglevel error -show_format -show_streams $FILE -print_format csv | grep format | cut -d "," -f 13 | cut -d "." -f 1`
#DURATION=`ffprobe -loglevel error -show_format -show_streams $FILE -print_format csv | grep format | cut -d "," -f 8 | cut -d "." -f 1`
